...
|----|--------|----------------|-----------|-----------|--------|------------|---------|---------|
| flash | $0.0262 | 4.40 | - | 0.0 | 0 | 0 | 3 | 0 |
| pro | $0.0952 | 4.33 | - | 0.0 | 0 | 0 | 3 | 0 |
| route | $0.0659 | 4.70 | 0.852 | 1.0 | 0 | 0 | 0 | 0 |

**核心结论：路由 vs 全 pro → 省 30.8% 成本，质量差 -0.37 分（路由准确率 0.852）**
...
| e06 | 什么是 RAG？ | simple/in_kb | simple/in_kb | ❌ | 5 | True |
...
| e18 | 模型选型要考虑哪四个要素？ | simple/in_kb | simple/in_kb | ❌ | 1 | True |
