...
|----|--------|----------------|-----------|-----------|--------|------------|---------|---------|
| flash | $0.0313 | 4.21 | - | 0.0 | 0 | 0 | 3 | 2 |
| pro | $0.1439 | 4.27 | - | 0.0 | 0 | 0 | 3 | 0 |
| route | $0.0843 | 4.78 | 0.926 | 1.0 | 0 | 0 | 0 | 0 |

**核心结论：路由 vs 全 pro → 省 41.4% 成本；in_kb 子集质量差 -0.15 分（route 4.78 vs pro 4.63），路由准确率 0.926，拒答正确率 1.0**
...
| e13 | model-landscape 里最贵的是哪个模型？ | simple/in_kb | complex/uncertain | ❌ | 5 | True |
...
| e18 | 模型选型要考虑哪四个要素？ | simple/in_kb | complex/in_kb | ❌ | 5 | True |
