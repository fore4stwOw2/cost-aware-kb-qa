...
> 生成日期：2026-09-02 ｜ 评测集：`data/eval_set.csv` 30 条（典型 20 + 边界 7 + 对抗 3）
...
|----|--------|----------------|-----------|-----------|--------|------------|---------|---------|
| flash | $0.0338 | 4.13 | - | 0.0 | 0 | 0 | 3 | 0 |
| pro | $0.1478 | 4.53 | - | 0.0 | 0 | 0 | 3 | 0 |
| route | $0.0924 | 4.26 | 0.926 | 1.0 | 0 | 0 | 0 | 0 |

**核心结论：路由 vs 全 pro → 省 37.5% 成本；in_kb 子集质量差 +0.67 分（route 4.26 vs pro 4.93），路由准确率 0.926，拒答正确率 1.0**
...
| e09 | gpt-5-nano 的价格是多少？ | simple/in_kb | simple/in_kb | ❌ | 1 | True |
| e10 | Claude 输出单价一般是输入单价的几倍？ | simple/in_kb | simple/in_kb | ❌ | 5 | True |
| e11 | 缓存命中读取价格比基础价便宜多少？ | simple/in_kb | simple/in_kb | ❌ | 5 | True |
| e12 | Opus 4.1 和 Sonnet 4 的输入价格分别是 | simple/in_kb | simple/in_kb | ❌ | 3 | True |
| e13 | model-landscape 里最贵的是哪个模型？ | simple/in_kb | complex/in_kb | ❌ | 5 | True |
| e14 | DeepSeek 有视觉模型吗？ | simple/in_kb | simple/in_kb | ❌ | 5 | True |
| e15 | 上下文窗口超过 27 万 token 后怎么计费？ | complex/in_kb | complex/in_kb | ❌ | 5 | True |
| e16 | 哪家模型最适合做客服问答？ | complex/in_kb | complex/in_kb | ❌ | 5 | True |
| e17 | 对比 DeepSeek 和 Claude 的定价策略并给 | complex/in_kb | complex/in_kb | ❌ | 5 | True |
| e18 | 模型选型要考虑哪四个要素？ | simple/in_kb | complex/in_kb | ❌ | 1 | True |
| e19 | 自建模型 vs 调用 API 该怎么选？ | complex/in_kb | complex/in_kb | ❌ | 5 | True |
| e20 | 做成本测算要算哪些非 API 成本？ | complex/in_kb | complex/in_kb | ❌ | 3 | True |
| e21 | 便宜模型和贵模型怎么分工？ | complex/in_kb | complex/in_kb | ❌ | 1 | True |
| e22 | 长上下文 Pro 系列超过 200K 怎么收费？ | complex/in_kb | complex/in_kb | ❌ | 5 | True |
