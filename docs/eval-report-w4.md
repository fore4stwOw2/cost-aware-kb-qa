...
|----|--------|----------------|-----------|-----------|--------|------------|---------|---------|
| flash | $0.0331 | 4.40 | - | 0.0 | 0 | 0 | 3 | 0 |
| pro | $0.1422 | 4.38 | - | 0.0 | 0 | 0 | 3 | 1 |
| route | $0.0887 | 4.63 | 0.963 | 1.0 | 0 | 0 | 0 | 0 |

**核心结论：路由 vs 全 pro → 省 37.6% 成本；in_kb 子集质量差 +0.14 分（route 4.63 vs pro 4.77），路由准确率 0.963，拒答正确率 1.0**
...
| e15 | 上下文窗口超过 27 万 token 后怎么计费？ | complex/in_kb | complex/in_kb | ❌ | 3 | True |
